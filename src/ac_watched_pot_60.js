        ...
        <div className="scroll-div">
            <div className="bg-main">
                ...
                <div className="ac-body">
                    ...
                    <br />
                    <h2>Is that really the daylife you want to live?</h2>
                    <br />
                    ...
                    <ul>
                        ...
                        <li><h2>Spend more time on your yacht and less time on a screen</h2></li>
                    </ul>
                    <br />
                    ...
                    <br /><br />
                    <h1 className="ac-text-centered"><b>You should be searching for the 20% of your time</b></h1>
                    <br />
                    <h1 className="ac-text-centered"><b>that leads to 80% of your happiness.</b></h1>
                    <br /><br />
